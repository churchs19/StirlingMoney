	...
	public sealed class ColorSpaceHelper
	{
		...
		public static Color[] GetWheelColors(int alpha)
		{
			...
			for(int i=0 ; i<colorCount; i++)
			{
				...
				colors[i] = Color.FromArgb(Convert.ToByte(alpha), Convert.ToByte(temp.R), Convert.ToByte(temp.G), Convert.ToByte(temp.B));
			}
		...
		public static Color[] GetSpectrumColors(int alpha)
		{
			...
			for(int i=0; i<256; i++) colors[i] = Color.FromArgb(Convert.ToByte(alpha), 255, Convert.ToByte(i), 0);
			for(int i=0; i<256; i++) colors[i+(256)] = Color.FromArgb(Convert.ToByte(alpha), Convert.ToByte(255-i), 255, 0);
			for(int i=0; i<256; i++) colors[i+(256*2)] = Color.FromArgb(Convert.ToByte(alpha), 0, 255, Convert.ToByte(i));
			for(int i=0; i<256; i++) colors[i+(256*3)] = Color.FromArgb(Convert.ToByte(alpha), 0, Convert.ToByte(255-i), 255);
			for(int i=0; i<256; i++) colors[i+(256*4)] = Color.FromArgb(Convert.ToByte(alpha), Convert.ToByte(i), 0, 255);
			for(int i=0; i<256; i++) colors[i+(256*5)] = Color.FromArgb(Convert.ToByte(alpha), 255, 0, Convert.ToByte(255-i));
		...
		public static Color HexToColor(string hexColor)
		{
			...
			if(hexColor != String.Empty)
			{
				...
				return Color.FromArgb(0xFF, Convert.ToByte(Convert.ToInt32(r)), Convert.ToByte(Convert.ToInt32(g)), Convert.ToByte(Convert.ToInt32(b)));
			}
		...
		public static Color HSBtoColor(HSB hsb) 
		{
			...
			return Color.FromArgb(0xFF, Convert.ToByte(rgb.Red), Convert.ToByte(rgb.Green), Convert.ToByte(rgb.Blue));
		}
		...
		public static CIELch RGBtoLch(RGB rgb)
		{
			return RGBtoLch(rgb.Red, rgb.Green, rgb.Blue);
		}
		...
		{
			byte red = Convert.ToByte((1-cmyk.Cyan)*(1-cmyk.Black)*255);
			byte green = Convert.ToByte((1-cmyk.Magenta)*(1-cmyk.Black)*255);
			byte blue = Convert.ToByte((1-cmyk.Yellow)*(1-cmyk.Black)*255);
		...
		public static CIELch LabtoLch(double l, double a, double b)
		{
			var H = Math.Atan2( b, a );  //Quadrant by signs
		...
		public static CIELch LabtoLch(CIELab lab)
		{
			return LabtoLch(lab.L, lab.A, lab.B);
		}
		#endregion

		#region CIEL*C*Hº convert
		public static CIELab LchtoLab(double l, double c, double h)
		{
			var a = Math.Cos(h.DegreeToRadian()) * c;
			var b = Math.Sin(h.DegreeToRadian()) * c;
		...
		/// </summary>
		public static CIELab LchtoLab(CIELab lab)
		{
			return LchtoLab(lab.L, lab.A, lab.B);
		}
		...
		/// </summary>
		public static RGB LchtoRGB(double l, double c, double h)
		{
		...
		/// Converts CIELch to RGB.
		/// </summary>
		public static RGB LchtoRGB(CIELch lch)
		{
			return LchtoRGB(lch.L, lch.C, lch.H);
		}

		public static Color LchtoColor(double l, double c, double h)
		{
			RGB rgb = LchtoRGB(l, c, h);
			return Color.FromArgb(0xFF, Convert.ToByte(rgb.Red), Convert.ToByte(rgb.Green), Convert.ToByte(rgb.Blue));
		}

		public static Color LchtoColor(CIELch lch)
		{
			RGB rgb = LchtoRGB(lch);
			return Color.FromArgb(0xFF, Convert.ToByte(rgb.Red), Convert.ToByte(rgb.Green), Convert.ToByte(rgb.Blue));
		}
		#endregion
